...
const { isHarnessVariant, isAcknowledgedConfigVariant, normalizeVariant } = require("../lib/pipeline.js");
 ...
 */
function buildReport({ changes, flagged, rejected, unknownVariants, extractResult, ingestResult, labFreshness, runDate }) {
  const parts = [];
