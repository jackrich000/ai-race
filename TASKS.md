...
- [ ] **Fix automated extraction reliability** — Multiple extraction failures discovered 2026-04-27:
  ...
  - **Cutoff date filter**: Articles published before the last extraction date are skipped. This blocks manual `--url` extraction of older articles unless `--force` is used. Also skipped GPT-5.5 System Card (published Apr 22, cutoff Apr 23).
