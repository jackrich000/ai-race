...
- [ ] **Quarterly maintenance: ground truth re-verification + API credit top-up — Next: 2026-07-01** — Manually re-verify each documented ground truth in `project_extraction_groundtruths.md` (Anthropic 16, OpenAI 16, xAI 5, Google 15, DeepSeek 14, Qwen 8) against the current source page:
