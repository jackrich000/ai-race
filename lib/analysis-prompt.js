...
{
  "frontier": {
    "headline": "One punchy sentence highlighting the key developments in frontier progress across the selected period",
    "commentary": "1-2 sentences explaining and analysing the key developments"
  },
  "race": {
...
3. COMMENTARY: Add interpretation the stat cards alone don't convey. 1-2 sentences max per mode.
   - For frontier: Briefly analyse the changes and their implications. Look at the per-quarter breakdown. If progress was concentrated in specific quarters, or accelerated/decelerated notably, mention it.
